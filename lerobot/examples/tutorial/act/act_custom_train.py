...
policy=ACTPolicy.from_pretrained("./outputs/robot_learning_tutorial/act", config=cfg).to(device)
preprocessor, postprocessor = make_act_pre_post_processors(cfg, dataset_stats=dataset_metadata.stats)
