...
from .config import GymXArmConfig
...
class GymXArm(Robot):
    ...
    def __init__(self, config: GymXArmConfig):
    ...
    def connect(self, calibrate: bool = True) -> None:
        ...
        """
        self.env = gym.make("gym_xarm/XarmLift-v0", obs_type="state", observation_width=128, observation_height=128)
